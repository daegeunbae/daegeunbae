...
# streamlit emoji shortcodes 에서 이미지 갖고 오기
st.markdown(
...
if fl is not None:
    ...
    # os.chdir(r"C:\Users\antonio\Desktop\05.Project\15.streamlit")
    os.chdir(r"/home/daegeunbae/다운로드/js/")
    df = pd.read_csv("Superstore.csv", encoding="ISO-8859-1")

col1, col2 = st.columns((2))
df["Order Date"] = pd.to_datetime(df["Order Date"])

# 가장 오래된 날짜와 최신 날짜 불러오기
...
# Sales 열의 데이터 유형을 바이트(bytes)로 수정
# category_df['Sales'] = category_df['Sales'].astype(bytes)
